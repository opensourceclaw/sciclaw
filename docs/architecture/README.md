# SciClaw - Technical Architecture Design
...
```
User → OpenClaw → SciClaw Skill → Results
```
...
```
User → OpenClaw → neoclaw Plugin → Full SciClaw
```
...
|-----------|--------|----------|
| Research Reports | Markdown (.md) | `~/.deepclaw/data/research/` |
| Metadata | JSON | `~/.deepclaw/metadata/` |
| Search Cache | JSON | `~/.deepclaw/cache/` |
| User Config | JSON | `~/.deepclaw/config.json` |
...
---
*Generated by SciClaw v{version}*
```
