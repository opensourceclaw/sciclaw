...
### 1. 定位与目标用户
- **定位**: "SciClaw — verifiable deep research for AI4S"；智能体家族独立成员，服务 AI4S（AI for Science），与 DevClaw（AI4SWE）无直接依赖，仅同属生态家族
...
- 家族协同：与 claw-* 家族（obs/cog/mem/ctx）同生态共享基建；家族成员之一，非任何单项目附属
...
### 4. 差异化（Why us）
- 「过程可信」差异化叙事 + claw-* 家族基础设施（obs/cog/mem/ctx）现成集成
...
### 5. 商业模式（How）
- 开源框架（Apache-2.0）+ 私有仓（current private）——智能体家族的 AI4S 垂直成员，反哺方法论与案例
