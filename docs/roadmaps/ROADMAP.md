...
SciClaw 专注于 **Deep Research**（深度研究）而非简单搜索：
- 搜索 → 多轮迭代检索
- 综合 → 深度理解和分析
- 报告 → 结构化知识输出
...
SciClaw 当前为 Python + TypeScript 混合代码（100 TS + 70 Python），与 OpenClaw 生态其他项目（devclaw 已 100% TS）技术栈不一致。
...
*Aligned with SciClaw Vision v2.0*
