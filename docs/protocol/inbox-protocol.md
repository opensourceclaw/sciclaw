> **Synced from DevClaw** on 2026-07-24 · This project: deepclaw
...
This document defines the communication protocol for DevClaw's AI-Native multi-agent system. All agents communicate through the inbox file system, enabling persistent sessions and high cache hit rates.
...
Agent role names are configurable. DevClaw uses platform-standard defaults:

| DevClaw Role | Platform Default | Environment Variable |
|-------------|------------------|---------------------|
...
- DevClaw resolves agent names from `From`/`To` fields using the configured mapping
...
With v7.0.0-rc.16, DevClaw introduces **Separation of Powers** governance:
...
| DevClaw Role | Platform Default | Inbox Directory | Description |
| --------------- | ------ | --------------- | ---------------------- |
...
*Generated by DevClaw ProcessOrchestrator (v7.0.0-rc.16)*
```
