...
export class SynthesisAgent extends BaseAgent {
  ...
  private computeCrossReferences(sources: Array<{ url: string; title: string; content: string }>): Array<{
    sourceA: string;
    sourceB: string;
    agreement: number;
    contradictions: string[];
  }> {
    const refs: Array<{ sourceA: string; sourceB: string; agreement: number; contradictions: string[] }> = [];
  ...
  private computeAgreement(contentA: string, contentB: string): number {
