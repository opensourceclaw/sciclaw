...
import { ResearchReport, Source } from './report_formatter.js';
 ...
 */
export const DEFAULT_STYLE: PDFStyleSettings = {
 ...
 * APA Style settings
 */
export const APA_STYLE: PDFStyleSettings = {
  ...DEFAULT_STYLE,
  fontFamily: 'Helvetica',
  fontSizeBody: 11,
  lineHeight: 1.5,
 ...
 * MLA Style settings
 */
export const MLA_STYLE: PDFStyleSettings = {
  ...DEFAULT_STYLE,
 ...
 */
export function convertMarkdownToText(text: string): string {
  let result = text;
...
export async function reportToPdf(
  ...
  overrides: Partial<PDFStyleSettings> = {}
): Promise<void> {
  const styleMap: Record<string, PDFStyleSettings> = {
...
// Export all
export default {
  PDFFooterSettings: {} as PDFFooterSettings,
  PDFHeaderSettings: {} as PDFHeaderSettings,
  PDFStyleSettings: {} as PDFStyleSettings,
  DEFAULT_STYLE,
  APA_STYLE,
  MLA_STYLE,
  exportToPdf,
