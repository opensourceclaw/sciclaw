...
export class PerformanceMetrics {
  ...
  getSnapshot(): MetricsSnapshot {
    ...
    const perSource: Record<string, { p95: number; avg: number; successRate: number }> = {};
    const sourceMap = new Map<string, LatencyRecord[]>();
  ...
  private getWindowRecords(): LatencyRecord[] {
    this.prune();
    return this.records;
  }
}
