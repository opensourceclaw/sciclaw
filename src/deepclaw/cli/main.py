...
from deepclaw.research.synthesizer import ResearchReport
...
from deepclaw.i18n import I18n, t
...
def get_api_key_for_engine(engine: str) -> str:
    ...
    """
    try:
        from deepclaw.config import get_config
        config = get_config()
...
def research(topic, depth, output, format, engine, verbose, quiet):
    ...
    Examples:
        ...
        deepclaw research "AI" --output ./reports/ai.md
        deepclaw research "AI" --format html
    """
...
```bash
deepclaw research "{topic or 'your topic'}"
```
""")
