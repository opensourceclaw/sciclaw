...
let KimiProvider = (() => {
    let _classDecorators = [registerLLMProvider("kimi")];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = LLMProvider;
    var KimiProvider = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            KimiProvider = _classThis = _classDescriptor.value;
        ...
        constructor(config = {}) {
            super(config);
            this.baseUrl = config.baseUrl || KimiProvider.DEFAULT_BASE_URL;
            this.embeddingModel = config.embeddingModel || KimiProvider.DEFAULT_EMBEDDING_MODEL;
        }
        get name() {
            return "kimi";
        }
        ...
        get supportedModels() {
            return KimiProvider.SUPPORTED_MODELS;
        }
        getHeaders() {
            return {
    ...
    return KimiProvider = _classThis;
})();
export { KimiProvider };
