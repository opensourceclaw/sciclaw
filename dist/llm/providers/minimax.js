...
let MiniMaxProvider = (() => {
    let _classDecorators = [registerLLMProvider("minimax")];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = LLMProvider;
    var MiniMaxProvider = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            MiniMaxProvider = _classThis = _classDescriptor.value;
        ...
        constructor(config = {}) {
            ...
            this.embeddingModel = config.embeddingModel || MiniMaxProvider.DEFAULT_EMBEDDING_MODEL;
        }
        get name() {
            return "minimax";
        }
    ...
    return MiniMaxProvider = _classThis;
})();
