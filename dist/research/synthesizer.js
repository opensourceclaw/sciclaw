...
export class ReportFormatter {
     ...
     */
    static getExecutiveSummary(report) {
        ...
        const avgConfidence = report.sections.reduce((sum, s) => sum + s.confidence, 0) / report.sections.length;
     ...
     */
    static getTableOfContents(report) {
        if (report.sections.length === 0) {
            return "";
        }
     ...
     */
    static confidenceIndicator(confidence) {
        if (confidence >= 0.8)
            return "✅";
        if (confidence >= 0.6)
            return "👍";
     ...
     */
    static formatMarkdown(report, options = {}) {
        ...
        lines.push(`*Report generated by DeepClaw v${report.version}*`);
        return lines.join("\n");
    }
    /**
...
`;
        ...
        html += `<div class='footer'>Report generated by DeepClaw v${report.version}</div>\n</body></html>`;
        return html;
    }
}
/**
 ...
 */
export function synthesize(topic, findings) {
