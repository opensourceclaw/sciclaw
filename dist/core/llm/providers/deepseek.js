...
let DeepSeekProvider = class DeepSeekProvider extends LLMProvider {
    static { DeepSeekProvider_1 = this; }
    static DEFAULT_BASE_URL = "https://api.deepseek.com";
    static DEFAULT_MODEL = "deepseek-chat";
    static DEFAULT_EMBEDDING_MODEL = "deepseek-embedding";
    ...
    constructor(config = {}) {
        super(config);
        this.baseUrl = config.baseUrl || DeepSeekProvider_1.DEFAULT_BASE_URL;
        this.embeddingModel = config.embeddingModel || DeepSeekProvider_1.DEFAULT_EMBEDDING_MODEL;
    }
    get name() {
        return "deepseek";
    }
    ...
    get defaultModel() {
        return DeepSeekProvider_1.DEFAULT_MODEL;
    }
    get supportedModels() {
        return DeepSeekProvider_1.SUPPORTED_MODELS;
    }
    getHeaders() {
        return {
...
DeepSeekProvider = DeepSeekProvider_1 = __decorate([
