...
let GLMProvider = class GLMProvider extends LLMProvider {
    static { GLMProvider_1 = this; }
    ...
    constructor(config = {}) {
        super(config);
        this.baseUrl = config.baseUrl || GLMProvider_1.DEFAULT_BASE_URL;
        this.embeddingModel = config.embeddingModel || GLMProvider_1.DEFAULT_EMBEDDING_MODEL;
    }
    get name() {
        return "glm";
    }
    ...
    get defaultModel() {
        return GLMProvider_1.DEFAULT_MODEL;
    }
    get supportedModels() {
        return GLMProvider_1.SUPPORTED_MODELS;
    }
    getHeaders() {
        return {
...
GLMProvider = GLMProvider_1 = __decorate([
    registerLLMProvider("glm")
], GLMProvider);
export { GLMProvider };
