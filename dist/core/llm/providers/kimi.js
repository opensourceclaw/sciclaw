...
let KimiProvider = class KimiProvider extends LLMProvider {
    static { KimiProvider_1 = this; }
    static DEFAULT_BASE_URL = "https://api.moonshot.cn/v1";
    static DEFAULT_MODEL = "moonshot-v1-8k-chat";
    static DEFAULT_EMBEDDING_MODEL = "moonshot-v1-embed";
    ...
    constructor(config = {}) {
        super(config);
        this.baseUrl = config.baseUrl || KimiProvider_1.DEFAULT_BASE_URL;
        this.embeddingModel = config.embeddingModel || KimiProvider_1.DEFAULT_EMBEDDING_MODEL;
    }
    get name() {
        return "kimi";
    }
    ...
    get defaultModel() {
        return KimiProvider_1.DEFAULT_MODEL;
    }
    get supportedModels() {
        return KimiProvider_1.SUPPORTED_MODELS;
    }
    getHeaders() {
        return {
    ...
    async embeddings(texts, model) {
        ...
        const results = [];
        // Kimi API requires one text at a time
...
KimiProvider = KimiProvider_1 = __decorate([
    registerLLMProvider("kimi")
], KimiProvider);
export { KimiProvider };
